...
CMD /prod/api/target/release/api -- --database-url ${DATABASE_URL} --api-url ${API_URL} --biscuit-private-key ${BISCUIT_PRIVATE_KEY} --email-sender-address ${EMAIL_SENDER_ADDRESS} --smtp-connection-url ${SMTP_CONNECTION_URL}